...
use ebcandle_transformers::models::mixformer::{Config, MixFormerSequentialForCausalLM as MixFormer};
use ebcandle_transformers::models::phi::{Config as PhiConfig, Model as Phi};
use ebcandle_transformers::models::phi3::{Config as Phi3Config, Model as Phi3};
use ebcandle_transformers::models::quantized_mixformer::MixFormerSequentialForCausalLM as QMixFormer;

use ebcandle::{DType, Device, IndexOp, Tensor};
...
fn main() -> Result<()> {
    ...
    let model_id = match args.model_id {
        ...
        None => {
            if args.quantized {
                "lmz/ebcandle-quantized-phi".to_string()
            } else {
                match args.model {
            ...
            if args.quantized {
                ...
                match args.model {
                    ...
                    WhichModel::V2 | WhichModel::V2Old | WhichModel::V3 | WhichModel::V3Medium => {
                        ebcandle_examples::hub_load_safetensors(
                            &repo,
