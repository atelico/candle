...
use ebcandle::DType::{F32, U8};
use ebcandle::{DType, Device, Module, Result, Tensor};
use ebcandle_examples::{load_image, load_image_and_resize, save_image};
use ebcandle_nn::VarBuilder;
use ebcandle_transformers::models::depth_anything_v2::{DepthAnythingV2, DepthAnythingV2Config};
use ebcandle_transformers::models::dinov2;
...
pub fn main() -> anyhow::Result<()> {
    ...
    let dinov2_model_file = match args.dinov2_model {
        None => {
            ...
            let api = api.model("lmz/ebcandle-dino-v2".into());
