...
use ebcandle_nn::{Activation, VarBuilder};
use std::sync::Arc;
...
impl Module for SparseMoeBlock {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
        ...
        let routing_weights = ebcandle_nn::ops::softmax_last_dim(&router_logits)?;
        ...
        let shared_expert_output = shared_expert_output.broadcast_mul(&ebcandle_nn::ops::sigmoid(
