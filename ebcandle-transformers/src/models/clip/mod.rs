...
pub struct ClipModel {
    ...
    vision_model: ClipVisionTransformer,
    visual_projection: ebcandle_nn::Linear,
    text_projection: ebcandle_nn::Linear,
    logit_scale: Tensor,
}
...
impl ClipModel {
    pub fn new(vs: ebcandle_nn::VarBuilder, c: &ClipConfig) -> Result<Self> {
        ...
        let visual_projection = ebcandle_nn::linear_no_bias(
