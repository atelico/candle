...
use ebcandle_transformers::models::qwen2::{Config as ConfigBase, ModelForCausalLM as ModelBase};
use ebcandle_transformers::models::qwen2_moe::{Config as ConfigMoe, Model as ModelMoe};
...
impl Model {
    fn forward(&mut self, xs: &Tensor, s: usize) -> ebcandle::Result<Tensor> {
        match self {
