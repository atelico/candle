...
use ebcandle::{CpuStorage, CustomOp1, Layout, Result, Shape, Tensor};
...
impl CustomOp1 for LayerNorm {
    ...
    fn cuda_fwd(
        ...
        use ebcandle::cuda_backend::cudarc::driver::{LaunchAsync, LaunchConfig};
        ...
        let dst = ebcandle::CudaStorage::wrap_cuda_slice(dst, dev);
