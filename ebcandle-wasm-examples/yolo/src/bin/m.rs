use ebcandle_wasm_example_yolo::coco_classes;
use ebcandle_wasm_example_yolo::model::Bbox;
use ebcandle_wasm_example_yolo::worker::Model as M;
use ebcandle_wasm_example_yolo::worker::ModelPose as P;
