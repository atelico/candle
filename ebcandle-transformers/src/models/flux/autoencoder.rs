use ebcandle::{Result, Tensor, D};
use ebcandle_nn::{conv2d, group_norm, Conv2d, GroupNorm, VarBuilder};
...
fn scaled_dot_product_attention(q: &Tensor, k: &Tensor, v: &Tensor) -> Result<Tensor> {
    ...
    ebcandle_nn::ops::softmax_last_dim(&attn_weights)?.matmul(v)
}
...
impl ebcandle::Module for AttnBlock {
...
impl ebcandle::Module for ResnetBlock {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
        let h = xs
            .apply(&self.norm1)?
            .apply(&ebcandle_nn::Activation::Swish)?
            .apply(&self.conv1)?
            .apply(&self.norm2)?
            .apply(&ebcandle_nn::Activation::Swish)?
            .apply(&self.conv2)?;
...
impl ebcandle::Module for Downsample {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
...
impl ebcandle::Module for Upsample {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
...
impl ebcandle_nn::Module for Encoder {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
...
impl ebcandle_nn::Module for Decoder {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
...
impl ebcandle_nn::Module for DiagonalGaussian {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
...
impl ebcandle::Module for AutoEncoder {
    fn forward(&self, xs: &Tensor) -> Result<Tensor> {
