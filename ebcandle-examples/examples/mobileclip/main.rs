...
use ebcandle_transformers::models::mobileclip;
...
fn load_images<T: AsRef<std::path::Path>>(
    ...
    for path in paths {
        let tensor = ebcandle_examples::imagenet::load_image_with_std_mean(
            path,
            image_size,
            &[0.0, 0.0, 0.0],
            &[1.0, 1.0, 1.0],
...
pub fn main() -> anyhow::Result<()> {
    ...
    let vec_imgs = match args.images {
        Some(imgs) => imgs,
        None => vec![
            "ebcandle-examples/examples/stable-diffusion/assets/stable-diffusion-xl.jpg".to_string(),
            "ebcandle-examples/examples/yolo-v8/assets/bike.jpg".to_string(),
        ],
    };
...
pub fn tokenize_sequences(
    ...
    let vec_seq = match sequences {
        ...
        None => vec![
            ...
            "a robot holding a ebcandle".to_string(),
        ],
    };
