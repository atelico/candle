...
use ebcandle_transformers::models::segment_anything::sam;
use clap::Parser;
...
pub fn main() -> anyhow::Result<()> {
    ...
    let (image, initial_h, initial_w) =
        ebcandle_examples::load_image(&args.image, Some(sam::IMAGE_SIZE))?;
    ...
    let model = match args.model {
        ...
        None => {
            ...
            let api = api.model("lmz/ebcandle-sam".to_string());
    ...
    if args.generate_masks {
        ...
        for (idx, bbox) in bboxes.iter().enumerate() {
            ...
            ebcandle_examples::save_image_resize(
                &mask,
