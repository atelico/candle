...
use ebcandle_transformers::models::quantized_stable_lm::Model as QStableLM;
use ebcandle_transformers::models::stable_lm::{Config, Model as StableLM};
...
fn main() -> Result<()> {
    ...
    let model_id = match args.model_id {
        ...
        None => match args.which {
            Which::V1Orig => "lmz/ebcandle-stablelm-3b-4e1t".to_string(),
    ...
    let filenames = match args.weight_files {
        ...
        None => match (args.which, args.quantized) {
            ...
            (Which::V2, true) => {
                let gguf = api
                    .model("lmz/ebcandle-stablelm".to_string())
