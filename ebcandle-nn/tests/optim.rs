...
use ebcandle::test_utils::{to_vec0_round, to_vec2_round};

use anyhow::Result;
use ebcandle::{DType, Device, Tensor, Var};
use ebcandle_nn::{AdamW, Linear, Module, Optimizer, ParamsAdamW, SGD};
...
fn adamw_linear_regression_varmap() -> Result<()> {
    ...
    let mut var_map = ebcandle_nn::VarMap::new();
