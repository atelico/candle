...
use ebcandle::{streaming, Module, Result, StreamTensor, StreamingModule, Tensor};
...
pub struct Config {
    ...
    pub activation: ebcandle_nn::Activation,
    ...
    pub final_activation: Option<ebcandle_nn::Activation>,
}
...
pub struct SeaNetResnetBlock {
    ...
    skip_op: ebcandle::StreamingBinOp,
    span: tracing::Span,
}
...
impl SeaNetResnetBlock {
    ...
    pub fn new(
        ...
        Ok(Self {
            ...
            shortcut,
            activation,
            skip_op: streaming::StreamingBinOp::new(streaming::BinOp::Add, ebcandle::D::Minus1),
...
impl SeaNetEncoder {
    pub fn new(cfg: &Config, vb: VarBuilder) -> Result<Self> {
        if cfg.lstm > 0 {
            ebcandle::bail!("seanet lstm is not supported")
        }
...
pub struct SeaNetDecoder {
    ...
    final_conv1d: StreamableConv1d,
    final_activation: Option<ebcandle_nn::Activation>,
    span: tracing::Span,
}
