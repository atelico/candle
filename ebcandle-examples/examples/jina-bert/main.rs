...
use ebcandle_transformers::models::jina_bert::{BertModel, Config, PositionEmbeddingType};

use anyhow::Error as E;
use ebcandle::{DType, Module, Tensor};
...
impl Args {
    fn build_model_and_tokenizer(&self) -> anyhow::Result<(BertModel, tokenizers::Tokenizer)> {
        ...
        let device = ebcandle_examples::device(self.cpu)?;
...
pub fn normalize_l2(v: &Tensor) -> ebcandle::Result<Tensor> {
