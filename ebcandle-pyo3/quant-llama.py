# This example shows how the ebcandle Python api can be used to replicate llama.cpp.
import sys
from typing import Dict, Tuple, Any
import ebcandle
from ebcandle.models.llama import QuantizedLlama
from ebcandle import utils
...
def main():
    ...
    for token_idx in range(500):
        last_token = tokens[-1]
        lt = ebcandle.tensor([last_token]).unsqueeze(0)
        logits = model.forward(lt, len(tokens))
        # Greedy sampling for now
        # pr = ebcandle.nn.softmax(logits, -1)
