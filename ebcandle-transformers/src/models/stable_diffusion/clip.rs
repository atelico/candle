...
use ebcandle::{DType, Device, Result, Tensor, D};
...
impl ClipTextEmbeddings {
    fn new(vs: ebcandle_nn::VarBuilder, c: &Config) -> Result<Self> {
        let token_embedding =
            ebcandle_nn::embedding(c.vocab_size, c.embed_dim, vs.pp("token_embedding"))?;
        let position_embedding = ebcandle_nn::embedding(
...
impl ClipTextTransformer {
    pub fn new(vs: ebcandle_nn::VarBuilder, c: &Config) -> Result<Self> {
