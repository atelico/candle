...
use ebcandle_transformers::models::stable_diffusion;
use ebcandle_transformers::models::wuerstchen;
...
fn run(args: Args) -> Result<()> {
    ...
    let image_embeddings = {
        ...
        let prior = {
            ...
            let vb = unsafe {
                ebcandle_nn::VarBuilder::from_mmaped_safetensors(&[file], DType::F32, &device)?
            };
    ...
    for idx in 0..num_samples {
        ...
        ebcandle_examples::save_image(&image, image_filename)?
    }
    Ok(())
}
