...
use ebcandle_transformers::models::mistral::{Config, Model as Mistral};
use ebcandle_transformers::models::quantized_mistral::Model as QMistral;
...
fn main() -> Result<()> {
    ...
    let args = Args::parse();
    #[cfg(feature = "cuda")]
    ebcandle::quantized::cuda::set_force_dmmv(args.force_dmmv);
    ...
    let model_id = match args.model_id {
        ...
        None => {
            if args.quantized {
                ...
                "lmz/ebcandle-mistral".to_string()
            } else {
