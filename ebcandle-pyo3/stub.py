...
"""
CANDLE_SPECIFIC_TYPING = "from ebcandle.typing import _ArrayLike, Device, Scalar, Index, Shape\n"
CANDLE_TENSOR_IMPORTS = "from ebcandle import Tensor,DType,QTensor\n"
...
def pyi_file(obj, indent=""):
    ...
    if inspect.ismodule(obj):
        ...
        if obj.__name__ != "ebcandle.ebcandle":
...
if __name__ == "__main__":
    ...
    # Enable execution from the ebcandle and ebcandle-pyo3 directories
    cwd = Path.cwd()
    directory = "py_src/ebcandle/"
    if cwd.name != "ebcandle-pyo3":
        directory = f"ebcandle-pyo3/{directory}"
    ...
    write(ebcandle.ebcandle, directory, "ebcandle", check=args.check)
