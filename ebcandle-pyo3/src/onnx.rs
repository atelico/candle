...
use ebcandle_onnx::eval::{dtype, get_tensor, simple_eval};
use ebcandle_onnx::onnx::tensor_proto::DataType;
use ebcandle_onnx::onnx::tensor_shape_proto::dimension::Value;
use ebcandle_onnx::onnx::type_proto::{Tensor as ONNXTensor, Value as ONNXValue};
use ebcandle_onnx::onnx::{ModelProto, ValueInfoProto};
...
impl PyONNXModel {
    ...
    fn new(path: String) -> PyResult<Self> {
        let model: ModelProto = ebcandle_onnx::read_file(path).map_err(wrap_err)?;
