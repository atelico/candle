...
fn default_act() -> ebcandle_nn::Activation {
    ebcandle_nn::Activation::Gelu
}
...
impl Config {
    pub fn pixtral_12b_2409() -> Self {
        Self {
            ...
            head_dim: None,
            // Default
            hidden_act: ebcandle_nn::Activation::Gelu,
        }
    }
...
impl RotaryEmbedding {
    ...
    fn apply_rotary_emb_qkv(&self, q: &Tensor, k: &Tensor) -> Result<(Tensor, Tensor)> {
        ...
        let cos = &self.cos;
        let sin = &self.sin;
        let q_embed = ebcandle_nn::rotary_emb::rope(q, cos, sin)?;
        let k_embed = ebcandle_nn::rotary_emb::rope(k, cos, sin)?;
        Ok((q_embed, k_embed))
    }
}
...
impl Model {
    pub fn new(cfg: &Config, vb: VarBuilder) -> Result<Self> {
        ...
        let patch_conv = ebcandle_nn::conv2d_no_bias(
            cfg.num_channels,
            cfg.hidden_size,
            cfg.patch_size,
            conv2d_cfg,
