...
use ebcandle_transformers::models::llama2_c as model;
use ebcandle_transformers::models::llama2_c_weights as weights;
use ebcandle_transformers::models::quantized_llama2_c as qmodel;
mod training;
use clap::{Parser, Subcommand};

use anyhow::{Error as E, Result};
use byteorder::{LittleEndian, ReadBytesExt};
use ebcandle::{IndexOp, Tensor};
...
fn run_inference(args: &InferenceCmd, common_args: &Args) -> Result<()> {
    ...
    let (model, config, mut cache) = if is_gguf {
        ...
        let fake_vb = ebcandle_nn::VarBuilder::from_tensors(
            [
        ...
        let tensors = ebcandle::safetensors::load(config_path, &device)?;
        let vb = ebcandle_nn::VarBuilder::from_tensors(tensors, ebcandle::DType::F32, &device);
