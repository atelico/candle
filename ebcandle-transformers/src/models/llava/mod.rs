...
use ebcandle::{bail, Device, IndexOp, Result, Tensor};
use ebcandle_nn::{seq, Activation, Module, Sequential, VarBuilder};
...
impl LLaVA {
    ...
    pub fn prepare_inputs_labels_for_multimodal(
        ...
        // can easily be replaced by nonzero if it is implemented in ebcandle
        ...
        // can be replace by split if it is implemented in ebcandle
