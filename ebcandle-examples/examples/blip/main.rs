...
use ebcandle::{DType, Device, Result, Tensor};
use ebcandle_examples::token_output_stream::TokenOutputStream;
use ebcandle_nn::VarBuilder;
use ebcandle_transformers::models::blip;
use ebcandle_transformers::models::quantized_blip;
...
pub fn main() -> anyhow::Result<()> {
    ...
    let model_file = match args.model {
        None => {
            ...
            if args.quantized {
                let api = api.model("lmz/ebcandle-blip".to_string());
    ...
    let mut logits_processor =
        ebcandle_transformers::generation::LogitsProcessor::new(1337, None, None);
