...
fn main() -> anyhow::Result<()> {
    ...
    ebcandle::cuda::set_gemm_reduced_precision_f16(true);
    ebcandle::cuda::set_gemm_reduced_precision_bf16(true);
    ...
    for prompt_index in 0.. {
        ...
        if let Some(rest) = tos.decode_rest().map_err(ebcandle::Error::msg)? {
            print!("{rest}");
        }
        std::io::stdout().flush()?;
