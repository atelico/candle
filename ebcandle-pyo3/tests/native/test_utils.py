...
from ebcandle.utils import load_safetensors, save_gguf, load_gguf, save_safetensors
...
def test_can_roundtrip_safetensors():
    tensors = {
        "a": ebcandle.randn((16, 256)),
        "b": ebcandle.randn((16, 16)),
    }
...
def test_can_roundtrip_gguf():
    ...
    tensors = {
        "a": ebcandle.randn((16, 256)).quantize("q4_0"),
        "b": ebcandle.randn((16, 16)).quantize("f32"),
    }
