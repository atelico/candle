...
use ebcandle::{ModuleT, Result, Tensor};
use ebcandle_nn::{FuncT, VarBuilder};
...
fn fully_connected(
    ...
    let dropout1 = ebcandle_nn::Dropout::new(0.5);
    let dropout2 = ebcandle_nn::Dropout::new(0.5);
    let dropout3 = ebcandle_nn::Dropout::new(0.5);
    Ok(FuncT::new(move |xs, train| {
        ...
        let lin3 = ebcandle_nn::linear(4096, num_classes, vb.pp("head.fc"))?;
